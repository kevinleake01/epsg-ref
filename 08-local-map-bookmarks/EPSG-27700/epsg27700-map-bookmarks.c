...
int main(int argc, char *argv[])
{
  ...
  printf("<a href=\"https://epsg.io/map#srs=27700&x=%s&y=%s&z=15&layer=streets\">Epsg.io Map: Streets - Zoom x15</a><br>\n", argv[1], argv[2]);
  printf("<a href=\"https://epsg.io/map#srs=27700&x=%s&y=%s&z=15&layer=satellite\">Epsg.io Map: Satellite - Zoom x15</a><br>\n", argv[1], argv[2]);
  printf("<a href=\"https://epsg.io/map#srs=27700&x=%s&y=%s&z=15&layer=osm\">Epsg.io Map: Maptiler OSM - Zoom x15</a><br>\n", argv[1], argv[2]);
  printf("</p>\n");
  printf("</body>\n");
  printf("</html>\n");
}
