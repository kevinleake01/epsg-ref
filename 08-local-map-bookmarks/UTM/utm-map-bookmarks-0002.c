...
int main(int argc, char *argv[])
{
  ...
  printf("<br>\n");
  printf("--------------------------------------<br>\n");
  printf("EPSG.IO - Use this section for the Northern Hemisphere:<br>\n");
  printf("<br>\n");
  printf("<a href=\"https://epsg.io/transform#s_srs=326%s&x=%s&y=%s\">Epsg.io Transform</a><br>\n", argv[1], argv[3], argv[4]);
  printf("<a href=\"https://epsg.io/map#srs=326%s&x=%s&y=%s&z=10&layer=streets\">Epsg.io Map: Streets - Zoom x10</a><br>\n", argv[1], argv[3], argv[4]);
  printf("<a href=\"https://epsg.io/map#srs=326%s&x=%s&y=%s&z=10&layer=satellite\">Epsg.io Map: Satellite - Zoom x10</a><br>\n", argv[1], argv[3], argv[4]);
  printf("<a href=\"https://epsg.io/map#srs=326%s&x=%s&y=%s&z=10&layer=osm\">Epsg.io Map: Maptiler OSM - Zoom x10</a><br>\n", argv[1], argv[3], argv[4]);
  printf("<a href=\"https://epsg.io/map#srs=326%s&x=%s&y=%s&z=15&layer=streets\">Epsg.io Map: Streets - Zoom x15</a><br>\n", argv[1], argv[3], argv[4]);
  printf("<a href=\"https://epsg.io/map#srs=326%s&x=%s&y=%s&z=15&layer=satellite\">Epsg.io Map: Satellite - Zoom x15</a><br>\n", argv[1], argv[3], argv[4]);
  printf("<a href=\"https://epsg.io/map#srs=326%s&x=%s&y=%s&z=15&layer=osm\">Epsg.io Map: Maptiler OSM - Zoom x15</a><br>\n", argv[1], argv[3], argv[4]);
  printf("--------------------------------------<br>\n");
  printf("EPSG.IO - Use this section for the Southern Hemisphere:<br>\n");
  printf("<br>\n");
  printf("<a href=\"https://epsg.io/transform#s_srs=327%s&x=%s&y=%s\">Epsg.io Transform</a><br>\n", argv[1], argv[3], argv[4]);
  printf("<a href=\"https://epsg.io/map#srs=327%s&x=%s&y=%s&z=10&layer=streets\">Epsg.io Map: Streets - Zoom x10</a><br>\n", argv[1], argv[3], argv[4]);
  printf("<a href=\"https://epsg.io/map#srs=327%s&x=%s&y=%s&z=10&layer=satellite\">Epsg.io Map: Satellite - Zoom x10</a><br>\n", argv[1], argv[3], argv[4]);
  printf("<a href=\"https://epsg.io/map#srs=327%s&x=%s&y=%s&z=10&layer=osm\">Epsg.io Map: Maptiler OSM - Zoom x10</a><br>\n", argv[1], argv[3], argv[4]);
  printf("<a href=\"https://epsg.io/map#srs=327%s&x=%s&y=%s&z=15&layer=streets\">Epsg.io Map: Streets - Zoom x15</a><br>\n", argv[1], argv[3], argv[4]);
  printf("<a href=\"https://epsg.io/map#srs=327%s&x=%s&y=%s&z=15&layer=satellite\">Epsg.io Map: Satellite - Zoom x15</a><br>\n", argv[1], argv[3], argv[4]);
  printf("<a href=\"https://epsg.io/map#srs=327%s&x=%s&y=%s&z=15&layer=osm\">Epsg.io Map: Maptiler OSM - Zoom x15</a><br>\n", argv[1], argv[3], argv[4]);
  printf("--------------------------------------<br>\n");
