...
####################################
#
# --- EPSG:4326 MAP-BOOKMARKS ---
#
# This is a tool to quickly set your co-ordinates,
# using EPSG:4326, Valid Worldwide.
# 
# Example Usage:
# 
# gcc epsg4326-map-bookmarks.c; ./a.out 51.47786 -0.00147 "Royal Observatory Greenwich, London" > royal-observatory-greenwich.html
#
####################################
*/
...
int main(int argc, char *argv[])
{
  ...
  printf("</head>\n");
  printf("<body>\n");
  printf("<h1>EPSG:4326 Map Bookmarks<br>Valid for: Worldwide</h1>\n");
  printf("<h2>For %s<br>at EPSG:4326: %s %s</h2>\n", argv[3], argv[1], argv[2]);
  printf("<p>\n");
